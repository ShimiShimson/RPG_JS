...
//Enemy properties:       (name,         hp,    ep,  dmp,  dme, dfp, dfe, dge, exp,   gold,  lvl)
    ...
    enemies.push(new Enemy('Cockroach',  80,    0,   15,   0,   10,  10,  20,  15,    5,     3));
    ...
    enemies.push(new Enemy('Bat',        150,   0,   30,   0,   20,  20,  50,  35,    13,    7));
    enemies.push(new Enemy('Cat',        250,   0,   30,   0,   20,  20,  20,  40,    15,    8));
    enemies.push(new Enemy('Dog',        300,   0,   40,   0,   30,  5,   20,  45,    17,    9));
    enemies.push(new Enemy('Wolf',       500,   0,   100,  0,   40,  25,  20,  80,    40,    10));
